...
public class enigme1 {
	public static void main(String[] args) throws SlickException{
		...
		cases[1][2] = new Case("fin", 1, 2, 1, 1, exit);
		cases[2][0] = new Case("tu", 2, 0, 0, 0, garage);
		cases[2][1] = new Case("gar", 2, 1, 0, 0, garage);
		cases[2][2] = new Case("td", 2, 2, 0, 0, garage);
		TerrainJeu terrain = new TerrainJeu(cases, 3, 3);
		...
		Mobile M1 = new Mobile("M1", 1, new TactiquePlusProche(), projectilesLancables_M1, 1, 1, cases[1][0], cases[1][2]);
		ArrayList<Projectile> projectilesLancables_M2 = new ArrayList<Projectile>();
		projectilesLancables_M2.add(P);
		Mobile M2 = new Mobile("M2", 1, new TactiquePlusProche(), projectilesLancables_M2, 1, 2, cases[1][0], cases[1][2]);
		ArrayList<Projectile> projectilesLancables_M3 = new ArrayList<Projectile>();
		projectilesLancables_M3.add(P);
		Mobile M3 = new Mobile("M3", 1, new TactiquePlusProche(), projectilesLancables_M3, 1, 3, cases[1][0], cases[1][2]);
		ArrayList<Projectile> projectilesLancables_O = new ArrayList<Projectile>();
		projectilesLancables_O.add(P);
		Obstacle O = new Obstacle("O", 1, new TactiquePlusFaible(), projectilesLancables_O, cases[2][1]);
		...
		// Partie finale
		Partie enigme1 = new Partie(listeElements, listeVagues, terrain, listeNiveaux);
		AppGameContainer app = new AppGameContainer(enigme1);
		int width;
		int height;
